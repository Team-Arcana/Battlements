...
public interface IActionCallback {
    ...
    public InteractionResultHolder<ItemStack> use(ItemStack item, Player player, net.minecraft.world.level.Level level, InteractionHand hand);
    ...
    public default int getUseDuration(ItemStack item, Entity entity){ return 72000; }
